        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6">
                    ...
                    <div class="section-heading-2 portfolio-pattern">
                        ...
                        <div class="p-pattern">
                            <img src="/public/assets/img/portfolio/p-pattern.png" alt="">
                        </div>
                    </div>
                </div>
            ...
            <div class="row portfolio-item-slider">
                ...
                <div class="single-portfolio-item">
                    <img src="/public/assets/img/portfolio/p1.png" alt="">
                ...
                <!--single potfolio item-->
                <div class="single-portfolio-item">
                    <img src="/public/assets/img/portfolio/p2.png" alt="">
                    <div class="portfolio-item-content">
                        <div class="item-icon">
                            <a href="#"><i class="fas fa-link"></i></a>
                        </div>
                ...
                <!--single potfolio item-->
                <div class="single-portfolio-item">
                    <img src="/public/assets/img/portfolio/p3.png" alt="">
                    <div class="portfolio-item-content">
                        <div class="item-icon">
                            <a href="#"><i class="fas fa-link"></i></a>
                        </div>
                ...
                <!--single potfolio item-->
                <div class="single-portfolio-item">
                    <img src="/public/assets/img/portfolio/p4.png" alt="">
                    <div class="portfolio-item-content">
                        <div class="item-icon">
                            <a href="#"><i class="fas fa-link"></i></a>
                        </div>
